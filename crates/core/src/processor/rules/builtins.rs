...
static BUILTIN_RULES: LazyLock<Vec<Rule>> = LazyLock::new(|| {
    vec![
        ...
        Rule { id: "address-validate".into(), name: "地址校验".into(), kind: RuleKind::Validate, field: None, pattern: None, replacement: None, enabled: true, description: "校验地址格式（中文+地址关键词）".into(), template: None, params: Some(ExtractParams::Address) },
